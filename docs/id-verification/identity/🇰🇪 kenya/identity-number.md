---
title: Identity Number Verification
sidebar_position: 5
---

## Identity Number Verification

Resolves the non-account information held against a Kenyan identity number. Use this when you have a number but do not yet know which document it belongs to.

```
POST /api/v1/id-verifications/identity/ke/id-scrub
```
